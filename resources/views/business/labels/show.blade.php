...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12 mb-4">
            ...
            <a href="{{ route('qrcode.create', ['data' => url()->route('tinyurl.redirect.label', ['id' => $label['id']]), 'width' => '400', 'height' => '400']) }}" target="_blank">
                <button class="btn-sm btn-primary mt-1 mb-1">{{ __('business/labels.table__button_qrcode') }}</button>
            </a>
            <a href="{{ route('business.labels.printa5', ['id' => $label['id']]) }}" target="_blank">
        ...
        <div class="col-md-12">
            <div class="card mb-4 pt-2">
                <div class="card-body">
                    ...
                    <div class="d-block font-lg">{{ __('business/settings.form__allowed_ips.title') . ': ' . ($label['allowed_ips'] ?? __('business/labels.allowed_all')) }}</div>
